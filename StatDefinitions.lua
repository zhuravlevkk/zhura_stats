...
local statDefinitions = {
    ...
    SPEED = { label = "Speed Rating", color = { 1.00, 0.85, 0.30 }, suffix = "%", rating = function() return GetCombatRating and (GetCombatRating(CR_SPEED) or 0) or 0 end, value = function() return GetSpeed and (GetSpeed() or 0) or 0 end },
